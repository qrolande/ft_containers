//
// Created by Quayle Rolande on 6/5/22.
//
...
void	stack() {
	...
	std::cout << "TEST 1 assert\n";
	{
		...
		typedef ft::stack<char, deq> stack_deq;
		typedef ft::stack<char, vec> stack_vec;
	...
	long int res = ms2 - ms;
	std::cout << "ft_stack SUCCESS! Total time " << res << " ms!\n";
}
